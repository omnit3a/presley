...
/* package Presley-0.1.0.0 */
#ifndef VERSION_Presley
#define VERSION_Presley "0.1.0.0"
#endif /* VERSION_Presley */
#ifndef MIN_VERSION_Presley
#define MIN_VERSION_Presley(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Presley */
...
#define CURRENT_COMPONENT_ID "Presley-0.1.0.0-inplace-presley"
